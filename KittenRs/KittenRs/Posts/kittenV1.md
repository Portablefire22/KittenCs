...
any major dealbreakers for this specific instance, but why aren't I just using a sqlite file
to track everything?

I didn't need many routes so surely just one match block for everything would be fine? I only
...
read them. Sure they're crude but that's the fun of them, I just enjoy seeing the thought process
